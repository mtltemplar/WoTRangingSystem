# Embedded file name: mod_AdvancedAimingSystem
...
if __name__ == '__main__':
    appinfo = '{appname} ({appid}) {version} ({client} {clusters}) by {authors}'.format(appname=__application__[0], appid=__application__[2], version=__version__[0], client=__client__[1], clusters=', '.join(__client__[0]).upper(), authors=', '.join(__authors__))
    import sys, time
...
g_globals = {'appConfigFile': None,
 'appConfigReader': None,
 'appDefaultConfig': None,
 'appLoadingMessage': None}
g_globals['appConfigReader'] = XModLib.XMLConfigReader.XMLConfigReader((('SimpleShortcut', XModLib.XMLConfigReader.DataObjectXMLReaderMeta.construct('SimpleShortcutXMLReader', constructor=lambda shortcut, **kwargs: XModLib.KeyboardUtils.Shortcut(shortcut, **kwargs), sectionType='String')),
 ('AdvancedShortcut', XModLib.XMLConfigReader.DataObjectXMLReaderMeta.construct('AdvancedShortcutXMLReader', constructor=lambda shortcut: XModLib.KeyboardUtils.Shortcut(**shortcut), sectionType='Dict')),
 ('CorrectionPanelSettings', XModLib.XMLConfigReader.OptionalDictXMLReaderMeta.construct('PanelSettingsXMLReader', requiredKeys=('visible',), defaultKeys=('visible',))),
 ('TargetPanelSettings', XModLib.XMLConfigReader.OptionalDictXMLReaderMeta.construct('PanelSettingsXMLReader', requiredKeys=('visible',), defaultKeys=('visible',))),
 ('AimingPanelSettings', XModLib.XMLConfigReader.OptionalDictXMLReaderMeta.construct('PanelSettingsXMLReader', requiredKeys=('visible',), defaultKeys=('visible', 'template', 'position'))),
 ('InfoPanelsIngameSettings', XModLib.IngameSettings.IngameSettingsXMLReaderMeta.construct('InfoPanelsIngameSettingsXMLReader', constructor=XModLib.IngameSettings.IngameSettingsDictDataObject.loader('mods/GPCracker.AdvancedAimingSystem/gui/panels/ingame', True)))))
g_globals['appDefaultConfig'] = {'applicationEnabled': ('Bool', True),
 ...
 'modules': {'aimingInfo': {'enabled': ('Bool', True),
                            'aimingThreshold': ('Float', 1.05)},
             'targetScanner': {'enabled': ('Bool', True),
                               'scanMode': {'useStandardMode': ('Bool', True),
                               ...
                               'autoScan': {'enabled': ('Bool', True),
                                            'activated': ('Bool', True),
                                            'shortcut': ('AdvancedShortcut', {'sequence': ('String', 'KEY_LCONTROL+KEY_N'),
                                                          'switch': ('Bool', True),
                                                          'invert': ('Bool', False)}),
                                            'message': {'onActivate': ('LocalizedWideString', u'[TargetScanner] AutoMode ENABLED.'),
                                                        'onDeactivate': ('LocalizedWideString', u'[TargetScanner] AutoMode DISABLED.')}},
                               'manualOverride': {'enabled': ('Bool', False),
                                                  'shortcut': ('SimpleShortcut', 'KEY_NONE', {'switch': True,
                                                                'invert': False})}},
             'aimCorrection': {'arcade': {'enabled': ('Bool', False),
                                          'fixGunMarker': ('Bool', True),
                                          'manualMode': {'enabled': ('Bool', True),
                                                         'shortcut': ('SimpleShortcut', 'KEY_LALT', {'switch': False,
                                                                       'invert': False})},
                                          'targetMode': {'enabled': ('Bool', True),
                                                         'activated': ('Bool', True),
                                                         'shortcut': ('AdvancedShortcut', {'sequence': ('String', 'KEY_LCONTROL+KEY_K'),
                                                                       'switch': ('Bool', True),
                                                                       'invert': ('Bool', False)}),
                                                         'message': {'onActivate': ('LocalizedWideString', u'[ArcadeAimCorrection] TargetMode ENABLED.'),
                                                                     'onDeactivate': ('LocalizedWideString', u'[ArcadeAimCorrection] TargetMode DISABLED.')},
                                                         'distance': ('Vector2AsTuple', (50.0, 720.0))}},
                               'sniper': {'enabled': ('Bool', True),
                                          'fixGunMarker': ('Bool', True),
                                          'manualMode': {'enabled': ('Bool', True),
                                                         'shortcut': ('SimpleShortcut', 'KEY_LALT', {'switch': False,
                                                                       'invert': False})},
                               ...
                               'strategic': {'enabled': ('Bool', True),
                                             ...
                                             'targetMode': {'enabled': ('Bool', True),
                                                            ...
                                                            'shortcut': ('AdvancedShortcut', {'sequence': ('String', 'KEY_LCONTROL+KEY_K'),
                                                                          'switch': ('Bool', True),
                                                                          'invert': ('Bool', False)}),
                                                            'message': {'onActivate': ('LocalizedWideString', u'[StrategicAimCorrection] TargetMode ENABLED.'),
                               ...
                               'arty': {'enabled': ('Bool', False),
                                        ...
                                        'targetMode': {'enabled': ('Bool', True),
                                                       ...
                                                       'shortcut': ('AdvancedShortcut', {'sequence': ('String', 'KEY_LCONTROL+KEY_K'),
                                                                     'switch': ('Bool', True),
                                                                     'invert': ('Bool', False)}),
                                                       'message': {'onActivate': ('LocalizedWideString', u'[ArtyAimCorrection] TargetMode ENABLED.'),
                                                                   'onDeactivate': ('LocalizedWideString', u'[ArtyAimCorrection] TargetMode DISABLED.')}}}}},
 'plugins': {},
 'gui': {'enabled': ('Bool', True),
         'updateInterval': ('Float', 0.04),
         'panels': {'context': {'hideInfoPanel': ('LocalizedWideString', u'Hide this panel'),
                                'resetInfoPanel': ('LocalizedWideString', u'Reset ingame settings')},
                    'static': {'AdvancedAimingSystemCorrectionPanel': {'default': {'alpha': ('Float', 1.0),
                                                                                   'visible': ('Bool', False),
                                                                                   'background': ('String', ''),
                                                                       ...
                                                                       'arcade': ('CorrectionPanelSettings', {'alpha': ('Float', 1.0),
                                                                                   'visible': ('Bool', True),
                                                                                   'background': ('String', ''),
                                                                                   'tooltip': ('LocalizedWideString', u'Aim correction info panel.'),
                                                                                   'template': ('LocalizedExtendedTemplate', u'<p align="center"><font color="#00FF00" size="20" face="$UniversCondC">Distance locked: {manualInfo:.1f}m.</font></p>'),
                                                                                   'position': ('Vector2AsTuple', (0.0, 0.3)),
                                                                                   'size': ('Vector2AsTuple', (450.0, 25.0))}),
                                                                       'sniper': ('CorrectionPanelSettings', {'alpha': ('Float', 1.0),
                                                                                   'visible': ('Bool', True),
                                                                                   'background': ('String', ''),
                                                                                   'tooltip': ('LocalizedWideString', u'Aim correction info panel.'),
                                                                                   'template': ('LocalizedExtendedTemplate', u'<p align="center"><font color="#00FF00" size="20" face="$UniversCondC">Distance locked: {manualInfo:.1f}m.</font></p>'),
                                                                                   'position': ('Vector2AsTuple', (0.0, 0.3)),
                                                                                   'size': ('Vector2AsTuple', (450.0, 25.0))}),
                                                                       'strategic': ('CorrectionPanelSettings', {'alpha': ('Float', 1.0),
                                                                                      'visible': ('Bool', True),
                                                                                      'background': ('String', ''),
                                                                                      'tooltip': ('LocalizedWideString', u'Aim correction info panel.'),
                                                                                      ...
                                                                                      'position': ('Vector2AsTuple', (0.0, 0.3)),
                                                                                      'size': ('Vector2AsTuple', (450.0, 25.0))}),
                                                                       'arty': ('CorrectionPanelSettings', {'alpha': ('Float', 1.0),
                                                                                 'visible': ('Bool', True),
                                                                                 'background': ('String', ''),
                                                                                 'tooltip': ('LocalizedWideString', u'Aim correction info panel.'),
                                                                                 ...
                                                                                 'position': ('Vector2AsTuple', (0.0, 0.3)),
                                                                                 'size': ('Vector2AsTuple', (450.0, 25.0))})},
                               'AdvancedAimingSystemTargetPanel': {'default': {'alpha': ('Float', 1.0),
                                                                               'visible': ('Bool', False),
                                                                               'background': ('String', ''),
                                                                               ...
                                                                               'size': ('Vector2AsTuple', (450.0, 25.0))},
                                                                   'arcade': ('TargetPanelSettings', {'alpha': ('Float', 1.0),
                                                                               'visible': ('Bool', True),
                                                                               'background': ('String', ''),
                                                                               'tooltip': ('LocalizedWideString', u'Target scanner info panel.'),
                                                                               'template': ('LocalizedExtendedTemplate', u'<p align="center"><font color="{if|{insight}:#FF3F00:#FF7F00}" size="20" face="$UniversCondC">Target: {shortName}; Distance: {distance:.1f}m; Speed: {speedMS:.1f}m/s.</font></p>'),
                                                                               'position': ('Vector2AsTuple', (0.0, 0.4)),
                                                                               'size': ('Vector2AsTuple', (450.0, 25.0))}),
                                                                   'sniper': ('TargetPanelSettings', {'alpha': ('Float', 1.0),
                                                                               'visible': ('Bool', True),
                                                                               'background': ('String', ''),
                                                                               'tooltip': ('LocalizedWideString', u'Target scanner info panel.'),
                                                                               'template': ('LocalizedExtendedTemplate', u'<p align="center"><font color="{if|{insight}:#FF3F00:#FF7F00}" size="20" face="$UniversCondC">Target: {shortName}; Distance: {distance:.1f}m; Speed: {speedMS:.1f}m/s.</font></p>'),
                                                                               'position': ('Vector2AsTuple', (0.0, 0.4)),
                                                                               'size': ('Vector2AsTuple', (450.0, 25.0))}),
                                                                   'strategic': ('TargetPanelSettings', {'alpha': ('Float', 1.0),
                                                                                  'visible': ('Bool', True),
                                                                                  'background': ('String', ''),
                                                                                  'tooltip': ('LocalizedWideString', u'Target scanner info panel.'),
                                                                                  'template': ('LocalizedExtendedTemplate', u'<p align="center"><font color="{if|{insight}:#FF3F00:#FF7F00}" size="20" face="$UniversCondC">Target: {shortName}; Distance: {distance:.1f}m; Speed: {speedMS:.1f}m/s.</font></p>'),
                                                                                  'position': ('Vector2AsTuple', (0.0, 0.4)),
                                                                                  'size': ('Vector2AsTuple', (450.0, 25.0))}),
                                                                   'arty': ('TargetPanelSettings', {'alpha': ('Float', 1.0),
                                                                             'visible': ('Bool', True),
                                                                             'background': ('String', ''),
                                                                             'tooltip': ('LocalizedWideString', u'Target scanner info panel.'),
                                                                             'template': ('LocalizedExtendedTemplate', u'<p align="center"><font color="{if|{insight}:#FF3F00:#FF7F00}" size="20" face="$UniversCondC">Target: {shortName}; Distance: {distance:.1f}m; Speed: {speedMS:.1f}m/s.</font></p>'),
                                                                             'position': ('Vector2AsTuple', (0.0, 0.4)),
                                                                             'size': ('Vector2AsTuple', (450.0, 25.0))})},
                               'AdvancedAimingSystemAimingPanel': {'default': {'alpha': ('Float', 1.0),
                                                                               'visible': ('Bool', False),
                                                                   ...
                                                                   'arcade': ('AimingPanelSettings', {'alpha': ('Float', 1.0),
                                                                               'visible': ('Bool', True),
                                                                               'background': ('String', 'img://mods/GPCracker.AdvancedAimingSystem/icons/AimingInfoBackground.png'),
                                                                               'tooltip': ('LocalizedWideString', u'Aiming info panel.'),
                                                                               'template': ('LocalizedExtendedTemplate', u'<textformat leftmargin="20" rightmargin="20" tabstops="[0,70]"><font color="#64F0B4" size="20" face="$UniversCondC">\tRemains:\t{remainingAimingTime:.2f}s;\n\tDistance:\t{aimingDistance:.1f}m;\n\tDeviation:\t{deviation:.2f}m;\n\tFly time:\t{flyTime:.2f}s;\n\tHit angle:\t{hitAngleDeg:+.1f}dg;</font></textformat>'),
                                                                               'position': ('Vector2AsTuple', (0.4, -0.1)),
                                                                               'size': ('Vector2AsTuple', (175.0, 130.0))}),
                                                                   'sniper': ('AimingPanelSettings', {'alpha': ('Float', 1.0),
                                                                               'visible': ('Bool', True),
                                                                               'background': ('String', 'img://mods/GPCracker.AdvancedAimingSystem/icons/AimingInfoBackground.png'),
                                                                               'tooltip': ('LocalizedWideString', u'Aiming info panel.'),
                                                                               ...
                                                                               'size': ('Vector2AsTuple', (175.0, 130.0))}),
                                                                   'strategic': ('AimingPanelSettings', {'alpha': ('Float', 1.0),
                                                                                  'visible': ('Bool', True),
                                                                                  'background': ('String', 'img://mods/GPCracker.AdvancedAimingSystem/icons/AimingInfoBackground.png'),
                                                                                  'tooltip': ('LocalizedWideString', u'Aiming info panel.'),
                                                                                  ...
                                                                                  'size': ('Vector2AsTuple', (175.0, 130.0))}),
                                                                   'arty': ('AimingPanelSettings', {'alpha': ('Float', 1.0),
                                                                             'visible': ('Bool', True),
                                                                             'background': ('String', 'img://mods/GPCracker.AdvancedAimingSystem/icons/AimingInfoBackground.png'),
                                                                             'tooltip': ('LocalizedWideString', u'Aiming info panel.'),
                                                                             'template': ('LocalizedExtendedTemplate', u'<textformat leftmargin="20" rightmargin="20" tabstops="[0,70]"><font color="#B46464" size="20" face="$UniversCondC">\tRemains:\t{remainingAimingTime:.2f}s;\n\tDistance:\t{aimingDistance:.1f}m;\n\tDeviation:\t{deviation:.2f}m;\n\tFly time:\t{flyTime:.2f}s;\n\tHit angle:\t{hitAngleDeg:+.1f}dg;</font></textformat>'),
...
g_config = g_globals['appConfigReader'](XModLib.XMLConfigReader.openSection(g_globals['appConfigFile']), g_globals['appDefaultConfig'])
...
class AimingInfo(object):
    ...
    def getMacroData(self):
        ...
        if playerAimingInfo is not None:
            ...
            aimingFactor = XModLib.BallisticsMath.getAimingFactor(aimingStartTime, aimingStartFactor, dispersionFactor, expAimingTime, aimingThreshold=self.aimingThreshold)
            ...
            return {'expAimingTime': expAimingTime,
...
class TargetInfo(int):
    ...
    def __new__(cls, target, *args, **kwargs):
        if XModLib.VehicleInfo.isVehicle(target):
            return super(TargetInfo, cls).__new__(cls, target.id)
        else:
            return None
    ...
    def getDistance(self, actualOnly = False):
        ...
        if position is not None:
            return position.distTo(BigWorld.player().getOwnVehiclePosition())
        else:
            return
    ...
    def __repr__(self):
        return '{!s}(target=BigWorld.entity({!s}), lastLockTime={!r}, expiryTimeout={!r}, relockTimeout={!r})'.format(self.__class__.__name__, int.__repr__(self), self.lastLockTime, self.expiryTimeout, self.relockTimeout)
...
class TargetScanMode(tuple):
    __slots__ = ()
    _fields, _defaults = zip(('useStandardMode', True), ('useXRayMode', False), ('useBBoxMode', False), ('useBEpsMode', False), ('maxDistance', 720.0), ('boundsScalar', 2.5), ('autoScanInterval', 0.04), ('autoScanExpiryTimeout', 10.0), ('autoScanRelockTimeout', 0.16))
...
class TargetScanner(object):
    ...
    def _initInternalComponents(self):
        self._standardScanner = XModLib.TargetScanners.StandardScanner(self._targetScanMode.filterID, self._targetScanMode.filterVehicle)
        self._xrayScanner = XModLib.TargetScanners.XRayScanner(self._targetScanMode.filterID, self._targetScanMode.filterVehicle, self._targetScanMode.maxDistance)
        self._bboxScanner = XModLib.TargetScanners.BBoxScanner(self._targetScanMode.filterID, self._targetScanMode.filterVehicle, self._targetScanMode.maxDistance, self._targetScanMode.boundsScalar)
        self._bepsScanner = XModLib.TargetScanners.BEllipseScanner(self._targetScanMode.filterID, self._targetScanMode.filterVehicle, self._targetScanMode.maxDistance, self._targetScanMode.boundsScalar)
        self._updateCallbackLoop = XModLib.CallbackUtils.CallbackLoop(self._targetScanMode.autoScanInterval, XModLib.CallbackUtils.getMethodProxy(self._updateTargetInfo))
    ...
    def _performScanningProcedure(self):
        collidableEntities = XModLib.TargetScanners.getCollidableEntities(self._targetScanMode.filterID, self._targetScanMode.filterVehicle)
        primaryTarget = (self._standardScanner.getTarget() if self._targetScanMode.useStandardMode else None) or (self._xrayScanner.getTarget(collidableEntities) if self._targetScanMode.useXRayMode else None)
        secondaryTargets = set(self._bboxScanner.getTargets(collidableEntities) if self._targetScanMode.useBBoxMode else []) | set(self._bepsScanner.getTargets(collidableEntities) if self._targetScanMode.useBEpsMode else []) if primaryTarget is None else set([])
        ...
        if self.isManualOverrideInEffect or not self.autoScanActivated:
            ...
            if primaryTarget is not None:
                if self.targetInfo is not None and self.targetInfo.isAutoLocked and primaryTarget.id == self.targetInfo:
                    ...
                    self.targetInfo = TargetInfo(primaryTarget, lastLockTime=BigWorld.time(), expiryTimeout=self._targetScanMode.autoScanExpiryTimeout, relockTimeout=self._targetScanMode.autoScanRelockTimeout)
            elif len(secondaryTargets) == 1 and (self.targetInfo is None or self.targetInfo.isExpired):
                self.targetInfo = TargetInfo(secondaryTargets.pop(), lastLockTime=BigWorld.time(), expiryTimeout=self._targetScanMode.autoScanExpiryTimeout, relockTimeout=self._targetScanMode.autoScanRelockTimeout)
...
class BaseAimCorrection(object):
    ...
    def getMacroData(self):
        if self.manualEnabled and self.manualInfo is not None:
            return {'manualInfo': self.manualInfo}
        else:
            return
    ...
    def __repr__(self):
        return '{!s}(avatarInputHandlerCtrl={!r}, manualEnabled={!r}, targetEnabled={!r})'.format(self.__class__.__name__, self._aihc, self.manualEnabled, self.targetEnabled)
...
class ArcadeAimCorrection(BaseAimCorrection):
    ...
    def __repr__(self):
        return '{!s}(avatarInputHandlerCtrl={!r}, manualEnabled={!r}, targetEnabled={!r}, minDistance={!r}, maxDistance={!r})'.format(self.__class__.__name__, self._aihc, self.manualEnabled, self.targetEnabled, self.minDistance, self.maxDistance)
...
class StrategicAimCorrection(BaseAimCorrection):
    ...
    def __repr__(self):
        return '{!s}(avatarInputHandlerCtrl={!r}, manualEnabled={!r}, targetEnabled={!r}, ignoreVehicles={!r}, heightMultiplier={!r})'.format(self.__class__.__name__, self._aihc, self.manualEnabled, self.targetEnabled, self.ignoreVehicles, self.heightMultiplier)
...
class GuiInfoPanelContextMenuHandler(XModLib.pygui.battle.views.handlers.ContextMenuHandler.ContextMenuHandler):
    OPTIONS = (('hideInfoPanel',
      '_hideInfoPanel',
      g_config['gui']['panels']['context']['hideInfoPanel'],
      '',
      True,
      None), ('resetInfoPanel',
      '_resetInfoPanel',
      g_config['gui']['panels']['context']['resetInfoPanel'],
      '',
      True,
      None))
    ...
    def _getOptionsItems(cls):
        ...
        def _makeOptionsItems(options):
            return [ cls._makeItem(idx, label, optInitData={'enabled': enabled,
             'iconType': icon}, optSubMenu=_makeOptionsItems(submenu) if submenu is not None else submenu) for idx, handler, label, icon, enabled, submenu in options ]
    ...
    def _hideInfoPanel(self):
        gui.shared.g_eventBus.handleEvent(GuiEvent(GuiEvent.INFO_PANEL_INGAME_CONFIG, {'alias': self._alias,
         'config': {'visible': False}}), gui.shared.EVENT_BUS_SCOPE.BATTLE)
...
class GuiInfoPanel(XModLib.pygui.battle.views.components.panels.TextPanel.TextPanel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__config = {'template': ''}

    def py_onPanelDrag(self, x, y):
        super(GuiInfoPanel, self).py_onPanelDrag(x, y)
        self.fireEvent(GuiEvent(GuiEvent.INFO_PANEL_DRAG, {'alias': self.getAlias(),
         'position': (x, y)}), gui.shared.EVENT_BUS_SCOPE.BATTLE)

    def py_onPanelDrop(self, x, y):
        super(GuiInfoPanel, self).py_onPanelDrop(x, y)
        self.fireEvent(GuiEvent(GuiEvent.INFO_PANEL_DROP, {'alias': self.getAlias(),
         'position': (x, y)}), gui.shared.EVENT_BUS_SCOPE.BATTLE)
...
class GuiSettings(object):
    ...
    def getContextMenuHandlers():
        return (GuiCorrectionPanelContextMenuHandler.getHandler(GuiSettings.CORRECTION_PANEL_ALIAS), GuiTargetPanelContextMenuHandler.getHandler(GuiSettings.TARGET_PANEL_ALIAS), GuiAimingPanelContextMenuHandler.getHandler(GuiSettings.AIMING_PANEL_ALIAS))

    @staticmethod
    def getViewSettings():
        return (GuiCorrectionPanel.getSettings(GuiSettings.CORRECTION_PANEL_ALIAS), GuiTargetPanel.getSettings(GuiSettings.TARGET_PANEL_ALIAS), GuiAimingPanel.getSettings(GuiSettings.AIMING_PANEL_ALIAS))
...
class GuiBaseBusinessHandler(gui.Scaleform.framework.package_layout.PackageBusinessHandler):
    ...
    def _updatePanelConfig(alias, config):
        gui.shared.g_eventBus.handleEvent(GuiEvent(GuiEvent.INFO_PANEL_CONFIG, {'alias': alias,
         'config': config}), gui.shared.EVENT_BUS_SCOPE.BATTLE)
...
class GuiBattleBusinessHandler(GuiBaseBusinessHandler):
    ...
    def __init__(self, staticConfigs, ingameConfigs):
        ...
        super(GuiBattleBusinessHandler, self).__init__(((GuiEvent.INFO_PANEL_INGAME_CONFIG, self._handleInfoPanelIngameConfigEvent),
         ...
         (GuiEvent.AVATAR_CTRL_MODE, self._handleAvatarCtrlModeEvent)), gui.app_loader.settings.APP_NAME_SPACE.SF_BATTLE, gui.shared.EVENT_BUS_SCOPE.BATTLE)
...
class GuiGlobalBusinessHandler(GuiBaseBusinessHandler):
    ...
    def __init__(self, staticConfigs, ingameConfigs):
        self._staticConfigs = staticConfigs
        self._ingameConfigs = ingameConfigs
        super(GuiGlobalBusinessHandler, self).__init__(((gui.shared.events.ComponentEvent.COMPONENT_REGISTERED, self._handleComponentRegistrationEvent),), gui.app_loader.settings.APP_NAME_SPACE.SF_BATTLE, gui.shared.EVENT_BUS_SCOPE.GLOBAL)
...
class GuiController(object):
    ...
    def _initInternalComponents(self):
        self._updateCallbackLoop = XModLib.CallbackUtils.CallbackLoop(self._updateInterval, XModLib.CallbackUtils.getMethodProxy(self._updateInfoPanels))
    ...
    def _getAimCorrectionMacroData(self):
        ...
        if aimCorrection is not None:
            return aimCorrection.getMacroData()
        else:
            return
    ...
    def _getTargetInfoMacroData(self):
        ...
        if targetInfo is not None:
            return targetInfo.getMacroData()
        else:
            return
    ...
    def _updateInfoPanelMacroData(self, alias, macrodata):
        self.dispatchEvent(GuiEvent.INFO_PANEL_UPDATE, {'alias': alias,
         'macrodata': macrodata})
...
def new_BattleShared_getBusinessHandlers(old_BattleShared_getBusinessHandlers, *args, **kwargs):
    ...
    config = g_config['gui']
    if config['enabled']:
        result += (GuiBattleBusinessHandler(config['panels']['static'], config['panels']['ingame']), GuiGlobalBusinessHandler(config['panels']['static'], config['panels']['ingame']))
    return result
...
def new_Account_onBecomePlayer(self, *args, **kwargs):
    if g_globals['appLoadingMessage']:
        ...
        XModLib.ClientMessages.pushSystemMessage({'message': g_globals['appLoadingMessage'],
         'timestamp': time.time(),
         'icon': 'img://gui/maps/icons/library/InformationIcon-1.png'}, __application__[1], auxData=['Information'])
...
def new_AvatarInputHandler_init(self, *args, **kwargs):
    ...
    self.XTargetScanner = TargetScanner(targetScanMode=TargetScanMode(**config['scanMode']), autoScanActivated=config['autoScan']['enabled'] and config['autoScan']['activated']) if config['enabled'] else None
    config = g_config['modules']['aimingInfo']
    self.XAimingInfo = AimingInfo(aimingThreshold=config['aimingThreshold']) if config['enabled'] else None
    config = g_config['gui']
    self.XGuiController = GuiController(updateInterval=config['updateInterval']) if config['enabled'] else None
    return
...
def new_AvatarInputHandler_handleKeyEvent(old_AvatarInputHandler_handleKeyEvent, self, event):
    ...
    operatingControlModes = (aih_constants.CTRL_MODE_NAME.ARCADE,
        ...
        if mconfig['enabled']:
            ...
            if shortcutHandle and (not shortcutHandle.switch or shortcutHandle.pushed):
                ...
                if shortcutHandle.switch and fconfig['activated']:
                    XModLib.ClientMessages.showMessageOnPanel('Player', None, fconfig['message']['onActivate'], 'green')
                elif shortcutHandle.switch:
                    XModLib.ClientMessages.showMessageOnPanel('Player', None, fconfig['message']['onDeactivate'], 'red')
                targetScanner = getattr(self, 'XTargetScanner', None)
                if targetScanner is not None:
...
def new_OperatingControlMode_init(self, *args, **kwargs):
    if type(self) is AvatarInputHandler.control_modes.ArcadeControlMode:
        ...
        self.XAimCorrection = ArcadeAimCorrection(self, fixGunMarker=config['fixGunMarker'], manualEnabled=config['manualMode']['enabled'], targetEnabled=config['targetMode']['enabled'] and config['targetMode']['activated'], minDistance=config['targetMode']['distance'][0], maxDistance=config['targetMode']['distance'][1]) if config['enabled'] else None
        ...
        self.XAimCorrection = SniperAimCorrection(self, fixGunMarker=config['fixGunMarker'], manualEnabled=config['manualMode']['enabled'], targetEnabled=config['targetMode']['enabled'] and config['targetMode']['activated'], minDistance=config['targetMode']['distance'][0], maxDistance=config['targetMode']['distance'][1]) if config['enabled'] else None
        ...
        self.XAimCorrection = StrategicAimCorrection(self, fixGunMarker=config['fixGunMarker'], manualEnabled=config['manualMode']['enabled'], targetEnabled=config['targetMode']['enabled'] and config['targetMode']['activated'], ignoreVehicles=config['ignoreVehicles'], heightMultiplier=config['targetMode']['heightMultiplier']) if config['enabled'] else None
        ...
        self.XAimCorrection = ArtyAimCorrection(self, fixGunMarker=config['fixGunMarker'], manualEnabled=config['manualMode']['enabled'], targetEnabled=config['targetMode']['enabled'] and config['targetMode']['activated']) if config['enabled'] else None
    return
...
def new_OperatingControlMode_enable(self, *args, **kwargs):
    if type(self) in (AvatarInputHandler.control_modes.ArcadeControlMode,
     AvatarInputHandler.control_modes.SniperControlMode,
     AvatarInputHandler.control_modes.StrategicControlMode,
     AvatarInputHandler.control_modes.ArtyControlMode):
...
import XModLib.ClientMessages
import XModLib.TargetScanners
g_globals['appDefaultConfig']['plugins']['safeShot'] = {'enabled': ('Bool', False),
 'activated': ('Bool', True),
 'shortcut': ('AdvancedShortcut', {'sequence': ('String', 'KEY_LALT'),
               'switch': ('Bool', False),
               'invert': ('Bool', True)}),
 'message': {'onActivate': ('LocalizedWideString', u'[SafeShot] ENABLED.'),
 ...
 'reasons': {'team': {'enabled': ('Bool', True),
             ...
             'dead': {'enabled': ('Bool', True),
                      'template': ('LocalizedWideString', u'corpse')},
             'waste': {'enabled': ('Bool', False),
                       'template': ('LocalizedWideString', u'waste')}}}
g_config['plugins']['safeShot'] = g_globals['appConfigReader'](XModLib.XMLConfigReader.overrideOpenSubSection(g_globals['appConfigFile'], 'plugins/safeShot'), g_globals['appDefaultConfig']['plugins']['safeShot'])
p_inject_hooks = XModLib.HookUtils.HookEvent()
p_inject_ovrds = XModLib.HookUtils.HookEvent()
...
import XModLib.HookUtils
import XModLib.VehicleInfo
g_globals['appDefaultConfig']['plugins']['expertPerk'] = {'enabled': ('Bool', False),
 'cacheExtrasInfo': ('Bool', False),
 'cacheExpiryTimeout': ('Float', 30.0),
 'responseTimeout': ('Float', 5.0)}
g_config['plugins']['expertPerk'] = g_globals['appConfigReader'](XModLib.XMLConfigReader.overrideOpenSubSection(g_globals['appConfigFile'], 'plugins/expertPerk'), g_globals['appDefaultConfig']['plugins']['expertPerk'])
p_inject_hooks = XModLib.HookUtils.HookEvent()
p_inject_ovrds = XModLib.HookUtils.HookEvent()
...
class ExtrasInfoController(object):
    ...
    def activeRequestVehicleID(self):
        if self._requester.activeRequest is not None:
            return self._requester.activeRequest.vehicleID
        else:
            return 0
...
def new_PlayerAvatar_init(self, *args, **kwargs):
    ...
    self.XExtrasInfoController = ExtrasInfoController(self, cacheExtrasInfo=config['cacheExtrasInfo'], cacheExpiryTimeout=config['cacheExpiryTimeout'], responseTimeout=config['responseTimeout']) if config['enabled'] else None
    return
...
import XModLib.KeyboardUtils
import XModLib.ClientMessages
g_globals['appDefaultConfig']['plugins']['advancedArty'] = {'enabled': ('Bool', False),
 'cameraAdjustment': {'enabled': ('Bool', True),
                      'interpolationSpeed': ('Float', 5.0),
                      'disableInterpolation': ('Bool', True),
                      'disableHighPitchLevel': ('Bool', True)},
 'orthogonalView': {'enabled': ('Bool', True),
                    'activated': ('Bool', False),
                    'shortcut': ('AdvancedShortcut', {'sequence': ('String', 'KEY_LALT+KEY_MIDDLEMOUSE'),
                                  'switch': ('Bool', True),
                                  'invert': ('Bool', False)}),
                    'cameraDistance': ('Float', 700.0),
                    'preserveLastView': ('Bool', True)}}
g_config['plugins']['advancedArty'] = g_globals['appConfigReader'](XModLib.XMLConfigReader.overrideOpenSubSection(g_globals['appConfigFile'], 'plugins/advancedArty'), g_globals['appDefaultConfig']['plugins']['advancedArty'])
p_inject_hooks = XModLib.HookUtils.HookEvent()
p_inject_ovrds = XModLib.HookUtils.HookEvent()
...
import XModLib.HookUtils
import XModLib.KeyboardUtils
g_globals['appDefaultConfig']['plugins']['sniperModeSPG'] = {'enabled': ('Bool', False),
 'shortcut': ('SimpleShortcut', 'KEY_E', {'switch': True,
               'invert': False})}
g_config['plugins']['sniperModeSPG'] = g_globals['appConfigReader'](XModLib.XMLConfigReader.overrideOpenSubSection(g_globals['appConfigFile'], 'plugins/sniperModeSPG'), g_globals['appDefaultConfig']['plugins']['sniperModeSPG'])
p_inject_hooks = XModLib.HookUtils.HookEvent()
p_inject_ovrds = XModLib.HookUtils.HookEvent()
    ...
    if g_config['plugins']['sniperModeSPG']['enabled']:
        if not BigWorld.player().isGunLocked and not BigWorld.player().isOwnBarrelUnderWater:
            if self._aih.isSPG and bByScroll:
                self._aih.onControlModeChanged(aih_constants.CTRL_MODE_NAME.SNIPER, preferredPos=self.camera.aimingSystem.getDesiredShotPoint(), aimingMode=self.aimingMode, saveZoom=False, equipmentID=None)
    return
...
def new_ArcadeControlMode_handleKeyEvent(old_ArcadeControlMode_handleKeyEvent, self, isDown, key, mods, event = None):
    ...
    if not result and self._aih.isSPG:
        ...
        if mconfig['enabled']:
            ...
            if shortcutHandle and (not shortcutHandle.switch or shortcutHandle.pushed):
                if not BigWorld.player().isGunLocked and not BigWorld.player().isOwnBarrelUnderWater:
                    self._aih.onControlModeChanged(aih_constants.CTRL_MODE_NAME.SNIPER, preferredPos=self.camera.aimingSystem.getDesiredShotPoint(), aimingMode=self.aimingMode, saveZoom=True, equipmentID=None)
    return result
...
def new_SniperControlMode_handleKeyEvent(old_SniperControlMode_handleKeyEvent, self, isDown, key, mods, event = None):
    ...
    if not result and self._aih.isSPG:
        ...
        if mconfig['enabled']:
            ...
            if shortcutHandle and (not shortcutHandle.switch or shortcutHandle.pushed):
                if not BigWorld.player().isGunLocked and not BigWorld.player().isOwnBarrelUnderWater:
                    self._aih.onControlModeChanged(aih_constants.CTRL_MODE_NAME.ARCADE, preferredPos=self.camera.aimingSystem.getDesiredShotPoint(), turretYaw=self.camera.aimingSystem.turretYaw, gunPitch=self.camera.aimingSystem.gunPitch, aimingMode=self.aimingMode, closesDist=False)
    return result
...
import AvatarInputHandler.control_modes
import XModLib.HookUtils
g_globals['appDefaultConfig']['plugins']['autoAim'] = {'enabled': ('Bool', False),
 'useTargetScan': ('Bool', False),
 'useTargetInfo': ('Bool', False)}
g_config['plugins']['autoAim'] = g_globals['appConfigReader'](XModLib.XMLConfigReader.overrideOpenSubSection(g_globals['appConfigFile'], 'plugins/autoAim'), g_globals['appDefaultConfig']['plugins']['autoAim'])
p_inject_hooks = XModLib.HookUtils.HookEvent()
p_inject_ovrds = XModLib.HookUtils.HookEvent()
...
import XModLib.HookUtils
g_globals['appDefaultConfig']['plugins']['radialMenu'] = {'enabled': ('Bool', False),
 'useTargetScan': ('Bool', False),
 'useTargetInfo': ('Bool', False)}
g_config['plugins']['radialMenu'] = g_globals['appConfigReader'](XModLib.XMLConfigReader.overrideOpenSubSection(g_globals['appConfigFile'], 'plugins/radialMenu'), g_globals['appDefaultConfig']['plugins']['radialMenu'])
p_inject_hooks = XModLib.HookUtils.HookEvent()
p_inject_ovrds = XModLib.HookUtils.HookEvent()
